...
extern void CAN_cmd_motor(CAN_TYPE can_type,DJI_MOTOR_ID CMD_ID,int16_t motor1, int16_t motor2, int16_t motor3, int16_t motor4);
...
extern void CAN_cmd_communication(CAN_TYPE can_type,DJI_MOTOR_ID CMD_ID,fp32 vx,fp32 vy);
