...
motor_measure_t motor_3508_measure[4];
...
//车轮电机的发送函数
void CAN_cmd_motor(CAN_TYPE can_type, DJI_MOTOR_ID CMD_ID, int16_t motor1, int16_t motor2, int16_t motor3, int16_t motor4) {
...
//                get_motor_measure(&motor_shoot_measure[FIRE_LEFT], rx_data);
//                detect_handle(DETECT_LAUNCHER_3508_FIRE_L);
//            }
//                break;
//
//            case CAN_LAUNCHER_3508_FIRE_R: {
//                get_motor_measure(&motor_shoot_measure[FIRE_RIGHT], rx_data);
//                detect_handle(DETECT_LAUNCHER_3508_FIRE_R);
//            }
//                break;
//
//            case CAN_LAUNCHER_2006_TRIGGER: {
//                get_motor_measure(&motor_shoot_measure[TRIGGER], rx_data);
//                get_motor_round_cnt(motor_shoot_measure[TRIGGER]);//获取转动拨轮电机转动圈数和总编码值
